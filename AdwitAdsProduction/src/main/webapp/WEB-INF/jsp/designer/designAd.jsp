...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Start Design|{Type of Ad}|CSR|AdwitAds</title>
		<meta charset="utf-8" />
                                        ...
                                        <div class="row ">
                                               ...
                                               <div class="row">
                                                ...
                                                <div class="col-md-12 col-sm-12 ps-6 pt-2 pb-2">
                                                 ...
                                                 <div class="col-md-12 ps-6 pt-2 pb-2">
                                                    <p>Advertiser Name:</p>
                                                    <p>Font Preference:</p>
                                                    <p>Instructions: <span class="fw-bold">Camera Ready / Follow Instructions / Be Creative</span></p>
                                            ...
                                            <div class="col-md-6 pb-6 pt-2 ps-4 pe-4">
                                                    ...
                                                    <div class="fv-row">
                                                        ...
                                                        <div class="dropzone bg-white border-gray-400" id="kt_dropzonejs_example_1">
                                                            ...
                                                            <div class="dz-message needsclick row text-center">
                                                                ...
                                                                <!--begin::Info-->
                                                                <div class="ms-4">
                                                                    <img src="assets/media/indesign.png" alt="idml"  class="img-50 pb-6"/>
                                                ...
                                                <form class="form" action="#" method="post">
                                                    ...
                                                    <div class="fv-row">
                                                        <!--begin::Dropzone-->
                                                        <div class="dropzone bg-white border-gray-400" id="kt_dropzonejs_example_12">
                                                            <!--begin::Message-->
                                                            <div class="dz-message needsclick row text-center">
                                                                <!--begin::Icon-->
                                                                ...
                                                                <!--begin::Info-->
                                                                <div class="ms-4">
                                                                    <img src="assets/media/pdf1.png" alt="pdf"  class="img-50 pb-6"/>
                                                  ...
                                                  <div class="fv-row">
                                                      ...
                                                      <div class="dropzone bg-white border-gray-400" id="kt_dropzonejs_example_13">
                                                          ...
                                                          <div class="dz-message needsclick row text-center">
                                                              ...
                                                              <!--begin::Info-->
                                                              <div class="ms-4">
                                                                <img src="assets/media/link.png" alt="images"  class="img-50 pb-6"/>
                                                  ...
                                                  <div class="fv-row">
                                                      ...
                                                      <div class="dropzone bg-white border-gray-400" id="kt_dropzonejs_example_14">
                                                          ...
                                                          <div class="dz-message needsclick row text-center align-items-center">
                                                              ...
                                                              <!--begin::Info-->
                                                              <div class="ms-4"> 
                                                                  <img src="assets/media/fonts1.png" alt="fonts"  class="img-50 pb-6"/>
                                                    ...
                                                    <div class="col-md-12 col-xs-12 pt-2 pb-2 right">
                                                        ...
                                                        <div class="border-top ">
                                                            ...
                                                            <div class="col-md-12 col-xs-12 pt-6 pb-2 right">
                                                                <button type="button" class="right btn btn-primary btn-sm col-md-3 col-xs-12" >End Design</button>
                                                            </div>
                                                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div  class="row ">
                        <iframe class="min-h-250px" src="assets/media/20.jpeg"  ></iframe>
                    </div>
...
//dropzone
var myDropzone = new Dropzone("#kt_dropzonejs_example_12", {
    url: "https://keenthemes.com/scripts/void.php", // Set the url for your upload script location
    paramName: "file", // The name that will be used to transfer the file
    maxFiles: 10,
    maxFilesize: 10, // MB
...
//dropzone
var myDropzone = new Dropzone("#kt_dropzonejs_example_13", {
    url: "https://keenthemes.com/scripts/void.php", // Set the url for your upload script location
    paramName: "file", // The name that will be used to transfer the file
    maxFiles: 10,
    maxFilesize: 10, // MB
...
//dropzone
var myDropzone = new Dropzone("#kt_dropzonejs_example_14", {
    url: "https://keenthemes.com/scripts/void.php", // Set the url for your upload script location
    paramName: "file", // The name that will be used to transfer the file
    maxFiles: 10,
    maxFilesize: 10, // MB
