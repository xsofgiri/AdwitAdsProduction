...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Accept Order|{Type of Ad}|CSR|AdwitAds</title>
		<meta charset="utf-8" />
                                            ...
                                            <div class="col-md-6  pb-6 pt-2 ps-4 pe-4">
                                               ...
                                               <div class="row">
                                                   <div class="col-md-12 ps-6 pt-6 ">
                                                      <p>Order Date:</p>
                                                      <p>Type of Ad: <span class="fw-bold">Print/Web</span></p>
                                                      <p>Color of Ad:</p>
                                                      <p>Color Preference: <span class="picker ">
                                                        
                                                        <input type="text" class="form-control border-color-radius" autocomplete="off" spellcheck="false">
                                                        <input type="color" class="form-control " value="#1aa7ff">
                                                      </span></p>
                                                      <p>Size of Ad:</p>
                                                    </div>
                                                ...
                                                <div class="col-md-12 col-sm-12 ps-6 pt-2 pb-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                         <span class="fw-bolder text-primary cursor-pointer" data-bs-toggle="modal" data-bs-target="#kt_modal_3">Link 1</span>
                                                        </br>
                                                        <span class="fw-bolder text-primary cursor-pointer">Link 2</span>
                                                     </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6 pb-6 pt-2 ps-4 pe-4">
                                                <div  class="row pt-2 ">
                                                    ...
                                                    <div class="col-md-4 col-sm-3 col-xs-6 pt-2 pb-2">
                                                        <div class="button-radio">
                                                            ...
                                                            <label class="btn btn-back-white btn-sm col-md-10 col-xs-10" for="a25">Pickup</label>
                                                          </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-3 col-xs-6 pt-2 pb-2">
                                                        <div class="button-radio">
                                                            <input type="radio" id="a50" name="check-substitution-2" />
                                                            <label class="btn btn-back-white btn-sm col-md-10 col-xs-10" for="a50">New Ad</label>
                                                          </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-3 col-xs-6 pt-2 pb-2">
                                                        <div class="button-radio">
                                                            ...
                                                            <label class="btn btn-back-white btn-sm col-md-10 col-xs-10" for="a75">Multi-listing</label>
                                                          </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-3 col-xs-6 pt-2 pb-2">
                                                        <div class="button-radio">
                                                            <input type="radio" id="a175" name="check-substitution-2" />
                                                            <label class="btn btn-back-white btn-sm col-md-10 col-xs-10" for="a175">Text Ad</label>
                                                          </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-3 col-xs-6 pt-2 pb-2">
                                                        <div class="button-radio">
                                                            <input type="radio" id="a715" name="check-substitution-2" />
                                                            <label class="btn btn-back-white btn-sm col-md-10 col-xs-10" for="a715">Web Ad</label>
                                                          </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-3 col-xs-6 pt-2 pb-2">
                                                        <div class="button-radio">
                                                            <input type="radio" id="a251" name="check-substitution-21" checked="checked" />
                                                            <label class="btn btn-back-white btn-sm col-md-10 col-xs-10" for="a251">Rush</label>
                                                          </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-3 col-xs-6 pt-2 pb-2">
                                                        <div class="button-radio">
                                                            <input type="radio" id="a502" name="check-substitution-21" />
                                                        ...
                                                        <div class="col-md-4 col-sm-3 col-xs-6 pt-2 pb-2">
                                                            <div class="button-radio">
                                                                <input type="radio" id="a253" name="check-substitution-211" checked="checked" />
                                                                <label class="btn btn-back-white btn-sm col-md-10 col-xs-10" for="a253">Yes</label>
                                                              </div>
                                                        </div>
                                                        <div class="col-md-4 col-sm-3 col-xs-6 pt-2 pb-2">
                                                            <div class="button-radio">
                                                                <input type="radio" id="a504" name="check-substitution-211" />
                                                                <label class="btn btn-back-white btn-sm col-md-10 col-xs-10" for="a504">Find New Art</label>
                                                              </div>
                                                        </div>
                        
                                                        <div class="col-md-4 col-sm-3 col-xs-6 pt-2 pb-2">
                                                            <div class="button-radio">
                                                                <input type="radio" id="a755" name="check-substitution-211" />
                                                                <label class="btn btn-back-white btn-sm col-md-10 col-xs-10" for="a755">No Art</label>
                                                              </div>
                                                        </div>
                                                            </div>
                                                ...
                                                <!--end::Form-->
                                                 <div class="col-md-6 col-xs-6 pt-6 pb-2">
                                                                <button type="button" class="btn btn-secondary btn-sm col-md-10 col-xs-10  text-color-white" data-bs-toggle="modal" data-bs-target="#kt_modal_5">Send Question</button>
                                                            </div>
                                                            <div class="col-md-6 col-xs-6 pt-6 pb-2 right">
                                                                <button type="button" class="right btn btn-success btn-sm col-md-10 col-xs-10" >Accept Order</button>
                                                            </div>
                                                        </div>
