											...
											<div class="mb-10">
                                                ...
                                                <div class="btn-group w-100 " data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                                                    ...
                                                    <label class="btn btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-dark active all" data-kt-button="true">
                                                        ...
                                                        <!--end::Input-->
                                                        All(<%=liveOrderList!=null?liveOrderList.size():0 %>)
                                                    </label>
                                                    <!--end::Radio-->
                                                    ...
                                                    <label class="questions btn btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-dark" data-kt-button="true">
                                                        ...
                                                        <!--end::Input-->
                                                        New Ads (<%=liveOrderList!=null?liveOrderList.size():0 %>)
                                                    </label>
                                                    <!--end::Radio-->
                                                     <!--begin::Radio-->
                                                     <label class="approved btn btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-dark" data-kt-button="true">
                                                        ...
                                                        <input class="btn-check" type="radio" name="method" value="4"  />
                                                        <!--end::Input-->
                                                        QA (<%=qaOrderList!=null?qaOrderList.size():0 %>)
                                                    </label>
                                                    ...
                                                    <table class="kt_datatable_example_5 table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                        ...
                                                        <tbody>
                                                            <%if(liveOrderList!=null && liveOrderList.size()>0){
                                                            	...
                                                            	%>
                                                            <tr>
                                                                <td><%=orders.getCreatedOn() %></td>
                                                                <td><%=orders.getOrderTypeId()==1?"Online":orders.getOrderTypeId()==2?"Print":"-" %></td>
                                                                <td><%=orders.getOrderId() %></td>
                                                                <td><%=liveOrder.getJobNo() %></td>
                                                                <td><%=orders.getAdvertiserName() %></td>
                                                                <td><%=orders.getAdRepName() %></td>
                                                                <td><%=liveOrder.getOrderStatusTitle()!=null?liveOrder.getOrderStatusTitle():"-" %></td>
                                                                <td>
                                                                	<%if(liveOrder.getProductionStatusId()==0){ %>
                                                                		<a href="<%=contextPath %>/orders/accept/<%=EncryptionUtil.encode(orders.getOrderId()) %>/" class="btn btn-success btn-sm col-md-10 col-xs-10">Accept</a>
                                                                	<%}else{ %>
                                                                		<a href="#" class="btn btn-danger btn-sm col-md-10 col-xs-10">Take Over</a>
                                                                	<%} %>
                                                                 </td>
                                                            </tr>
                                                            <%}
