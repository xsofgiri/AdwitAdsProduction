...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Submit Revision|{Type of Ad}|AdwitAds</title>
		<meta charset="utf-8" />
							...
							<div id="kt_content_container" class="container-xxl">
                                <div class="card mb-10">
									<div class="card-body  p-5 p-lg-8">
                                        ...
                                        <div class="row ">
                                            <div class="col-md-6 col-sm-12 ps-6 pe-6 pt-6 pb-6">
                                                <div class="mb-10">
                                                    <p>Enter Ad No.<sup>*</sup> <i class="bi bi-info-circle-fill" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="" data-bs-original-title="Tooltip on top" aria-label="Tooltip on top"></i></p>
                                                    <div class="position-relative  me-md-2">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <input type="text" class="form-control ps-10" name="search" value="" placeholder="Database">
                                                    </div>
                                                </div>
                                                <p>Download / View Files</p>
                                                <div class="row pt-2">
                                                    <div class="col-md-3 col-sm-3 col-xs-4 pt-2 pb-4">
                                            ...
                                            <div class="col-md-6 col-sm-12 ps-6 pe-6 pt-6 pb-6">
                                                <p>Select Type of Revision<sup>*</sup> <i class="bi bi-exclamation-circle-fill"></i></p>
                                                
                                            <div class="row ">
                
                                                <div class="col-md-3 col-sm-3 col-xs-6 pb-2">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-6 pb-2">
                                                    <div class="button-radio">
                                                        <input type="radio" id="a75" name="check-substitution-2">
                                                        <label class="btn btn-back-white btn-sm col-md-10 col-xs-10" for="a75">Extensive</label>
                                                      </div>
                                                </div> </div>
                                                <div class="row  pt-6 pb-6">
                                                    <p>Attach Files<sup>*</sup> <i class="bi bi-exclamation-circle-fill"></i></p>
                                                ...
                                                <div class="row ">
                                                    <div class="col-md-12  pb-6 pt-2 ps-4 pe-4">
                                                        ...
                                                        <div class="order-head border-radius-5 fw-bolder text-color-white">
                                                           Ad Proof - {Version 2}
                                                        </div>
                                                       <div class="row">
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-md-4 pt-2 pb-2 ">
                                                            <div class="form-check form-check-custom form-check-solid pt-3">
                                                        ...
                                                        <div class="col-md-4 col-xs-6 pt-2 pb-2 pe-6">
                                                            <button type="button" class=" btn btn-back-white btn-sm col-md-12 col-xs-10" >Back</button>
                                                        </div>
                                                        
                                                                <div class="col-md-4 col-xs-6 pt-2 pb-2 pe-6">
                                                                    <button type="button" class=" btn btn-primary btn-sm col-md-12 col-xs-10">Submit Revision</button>
                                                                </div>
                                                            </div>   </div> </div>
                                              </div>
                                        </div>
